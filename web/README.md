...
4. Optional: set `NEXT_PUBLIC_APP_URL` to `https://your-app.vercel.app` so downloaded Capture extensions come prefilled with the API URL.
5. Deploy. The build packs the extension zips and runs `prisma migrate deploy`.
